...
(defgeneric set-fill-color* (color)
  (:method ((color color))
    (set-rgb-fill (red color) (green color) (blue color)))
  (:method ((color color/alpha))
    (set-rgba-fill (red color) (green color) (blue color) (alpha color))))

(defgeneric set-stroke-color* (color)
  (:method ((color color))
    (set-rgb-stroke (red color) (green color) (blue color)))
  (:method ((color color/alpha))
    (set-rgba-stroke (red color) (green color) (blue color) (alpha color))))
...
(defun resaturate (color new-saturation)
  (multiple-value-bind (h s v)
      (hsv-values color)
    (hsv-color h new-saturation v)))